                        ...
                        <form action="{{URL::to('/admin_dashboard')}}" method="post">
                            ...
                            <div class="social-login-content">
                                <div class="social-button">
                                    <a class="loginBtn loginBtn--facebook" href="{{URL::to('/login_facebook')}}">Đăng Nhập Bằng Facebook</a>
                                    <!-- <button class="au-btn au-btn--block au-btn--blue m-b-20">Đăng Nhập Bằng Facebook</button> -->
                                    <a class="loginBtn loginBtn--google" href="{{URL::to('/login_google')}}">Đăng Nhập Bằng Google</a>
                                </div>
                            </div>
                        </form>
...
<!-- Vendor JS       -->
<script src="{{asset('public/admin/vendor/slick/slick.min.js')}}"></script>
...
<script src="{{asset('public/admin/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js')}}"></script>
<script src="{{asset('public/admin/vendor/counter-up/jquery.waypoints.min.js')}}"></script>
<script src="{{asset('public/admin/vendor/counter-up/jquery.counterup.min.js')}}"></script>

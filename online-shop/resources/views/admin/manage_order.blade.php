            ...
            <table class="table table-data2">
                ...
                <tbody>
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td class="desc">{{$value->order_total}}</td>
                        <td>{{$value->order_status}}</td>
                        <td>
                            <div class="table-data-feature">
                                <button class="item" data-toggle="tooltip" data-placement="top" title="Xem chi tiết">
                                    <a href="{{URL::to('/view_order/'.$value->order_id)}}"><i class="fa-solid fa-eye"></i></a>
                                </button>
                                <button class="item" data-toggle="tooltip" data-placement="top" title="Xóa">
                                    <a onclick="return confirm('Bạn muốn xóa danh mục này chứ?');" href="{{URL::to('/delete_order/'.$value->order_id)}}"><i class="zmdi zmdi-delete"></i></a>
                                </button>
                            </div>
                        </td>
                    </tr>

    ...
    <div class="cart-box-main">
        <div class="container">
            ...
            <div class="row my-5">
                ...
                ?>
                        <div class="col-12 d-flex shopping-box"><a href="{{URL::to('/show_checkout')}}" class="ml-auto btn hvr-hover">Thanh Toán</a></div>
                <?php
                    }elseif($customer_id && $shipping_id == NULL){          
                ?>
                        <div class="col-12 d-flex shopping-box"><a href="{{URL::to('/show_shipping')}}" class="ml-auto btn hvr-hover">Thanh Toán</a></div>
                <?php
                    }
                    else{
                ?>
